...
<body>
<table id="potentialcustomer_datagrid" headerCls="border_top_none"></table>
<!--定义底部按钮  -->
<div id="tt">
    <div>
        ...
        <a class="easyui-linkbutton" iconCls="icon-change" plain="true" data-cmd="change">转正</a>
        <a class="easyui-linkbutton" iconCls="icon-failOpen" plain="true" data-cmd="failOpen">开发失败</a>
...
<div id="potentialcustomer_dialog2">
    <form id="potentialcustomer_form2" method="post">
        <table align="center" style="margin-top: 15px">
            <input type="hidden" name="id"/>
            <tr>
                <td>当前潜在客户</td>
